...
namespace MouseDrag
{
    public class Options : OptionInterface
    {
        ...
        public static Configurable<bool> selectionXOR;
        ...
        public Options()
        {
            ...
            selectionXOR = config.Bind(nameof(selectionXOR), defaultValue: false, new ConfigurableInfo("When using the selection-rectangle, remove BodyChunks within the rectangle from the selection if they were already selected. Else just keep the selection.", null, "", "Selection XOR"));
        ...
        public override void Initialize()
        {
            ...
            AddCheckBox(selectionXOR, new Vector2(x, y -= sepr));
