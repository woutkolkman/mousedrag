...
namespace MouseDrag
{
    public class Options : OptionInterface
    {
        ...
        public Options()
        {
            ...
            devConsoleIntegration = config.Bind(nameof(devConsoleIntegration), defaultValue: true, new ConfigurableInfo("If Dev Console is enabled, additional commands are available via the console.\nOnly works if Mouse Drag is not loaded via Rain Reloader.", null, "", "Dev Console integration"));
