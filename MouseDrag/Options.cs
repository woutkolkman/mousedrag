...
namespace MouseDrag
{
    public class Options : OptionInterface
    {
        ...
        public Options()
        {
            ...
            showLabel = config.Bind(nameof(showLabel), defaultValue: true, new ConfigurableInfo("Show label above menu with name of selected creature/object.", null, "", "Show label"));
