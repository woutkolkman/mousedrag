...
namespace MouseDrag
{
    public class Options : OptionInterface
    {
        ...
        public static Configurable<bool> forceMouseVisibility, manageMouseVisibility, showLabel;
        ...
        public Options()
        {
            ...
            showLabel = config.Bind(nameof(showLabel), defaultValue: true, new ConfigurableInfo("Show label above menu with name of selected object.", null, "", "Show label"));
            ...
            lockKey = config.Bind(nameof(lockKey), KeyCode.None, new ConfigurableInfo("KeyBind to apply a position lock to the BodyChunk which you're currently dragging. A lock is lost if the object is reloaded.", null, "", "Lock"));
